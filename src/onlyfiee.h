...
namespace Fast_I{
    ...
    Fast_Istream&Fast_Istream::operator>>(char*_Val){
        if(_Ok){
            ...
            while(*_Val!=32&&*_Val!=10&&*_Val&&*_Val!=-1&&*_Val!=9&&*_Val!=11&&*_Val!=12){
                Get_Char(*++_Val);
            }
            *_Val=0;
            --_Start_ptr;
    ...
    Fast_Istream&Fast_Istream::operator>>(std::string&_Val){
        if(_Ok){
            ...
            for(_Val.clear();c!=32&&c!=10&&c&&c!=-1&&c!=9&&c!=11&&c!=12;Get_Char(c)){
                _Val.push_back(c);
            }
            --_Start_ptr;
        }
    ...
    Fast_Istream&Fast_Istream::operator>>(bool&_Val){
        if(_Ok){
            ...
            while(ch!=32&&ch!=10&&ch&&ch!=-1&&ch!=9&&ch!=11&&ch!=12){
                _Val|=ch!=48;
                Get_Char(ch);
            }
            --_Start_ptr;
